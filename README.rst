...
The first thing you want to do after creating an instance of this class is to call ``Akinator.start()``.
...
To get the **async** version of the class, make sure you have ``import akinator`` in your code and you'll be able to get the async Akinator class via ``akinator.AsyncAkinator()``.
...
start(*language=None, child_mode=False*)
